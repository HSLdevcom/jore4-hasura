...
VALUES
  ('101f800c-39ed-4d85-8ece-187cd9fe1c5e','65','Rautatientori - Veräjälaakso','Rautatientori - Kätilöopisto - Veräjälaakso','bus','65',10,'2021-01-01','2023-12-13'),
  ('9058c328-efdd-412c-9b2b-37b0f6a2c6fb','71','Rautatientori - Malmi as.','Rautatientori - Arabia - Malmi as.','bus','71',10,'2021-01-01','2023-12-13'),
  ('bbd1cb29-74c3-4fa1-ac86-918d7fa96fe2','785K','Rautatientori - Nikkilä','Rautatientori - Nikkilä','bus','785K',10,'2021-01-01','2023-12-13'),
  ('db748c5c-42e3-429f-baa0-e0db227dc2c8','1234','Erottaja - Arkkadiankatu','Erottaja - Arkkadiankatu','bus','1234',10,'2021-01-01','2023-12-13')
...
BEGIN
  ...
  VALUES
    ('e3528755-711f-4e4f-9461-7931a2c4bc6d'::uuid,'SRID=4326;POINT Z(24.928326557825727 60.16391811339392 0)'::geography,'c63b749f-5060-4710-8b07-ec9ac017cb5f'::uuid,'forward','pysäkki A',NULL,NULL,10),
	  ('f8eace87-7901-4438-bfee-bb6f24f1c4c4'::uuid,'SRID=4326;POINT Z(24.933251767757206 60.16565505738068 0)'::geography,'d3ed9fcf-d1fa-419a-a279-7ad3ffe47714'::uuid,'forward','pysäkki B',NULL,NULL,10)
  ON CONFLICT DO NOTHING;
...
VALUES
	('03d55414-e5cf-4cce-9faf-d86ccb7e5f98'::uuid,NULL,'f8eace87-7901-4438-bfee-bb6f24f1c4c4'::uuid,'e3528755-711f-4e4f-9461-7931a2c4bc6d'::uuid,'101f800c-39ed-4d85-8ece-187cd9fe1c5e'::uuid,NULL,NULL,10,'65 itään','outbound')
ON CONFLICT DO NOTHING;
