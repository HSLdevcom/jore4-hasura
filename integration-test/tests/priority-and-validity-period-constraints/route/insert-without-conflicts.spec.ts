...
describe("Insert route", () => {
  ...
  describe("whose validity period conflicts with defined validity end but has different direction", () => {
    const toBeInserted: Partial<Route> = {
  ...
  describe("whose validity period lies within other validity period but has different direction", () => {
    const toBeInserted: Partial<Route> = {
      description_i18n: "route 3",
      starts_from_scheduled_stop_point_id:
        scheduledStopPoints[0].scheduled_stop_point_id,
