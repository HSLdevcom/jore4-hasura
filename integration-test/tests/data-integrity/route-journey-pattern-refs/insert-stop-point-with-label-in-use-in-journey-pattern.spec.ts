...
describe('Inserting a stop point with a label in use in a journey pattern', () => {
  ...
  describe('with the same label and on the same link as another stop', () => {
  ...
  describe('with the same label and on the link previous to the link of another stop', () => {
  ...
  describe('with the same label and on a link after the link of the next stop with non-overlapping validity time', () => {
  ...
  describe('with the same label and on a link after the link of the next stop', () => {
