...
export const scheduledStopPointInvariants: ScheduledStopPointInvariant[] = uniq(
  scheduledStopPoints.map((scheduledStopPoint) => scheduledStopPoint.label),
).map((scheduledStopPointLabel) => ({
