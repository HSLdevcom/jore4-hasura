...
With the default value of 63 for the PostgreSQL option [`max_identifier_length`](https://www.postgresql.org/docs/13/runtime-config-preset.html) and the current choice of bracket delimiters:

- the names of the secrets containing the Jore4 DB usernames should have at most 55 ASCII characters
