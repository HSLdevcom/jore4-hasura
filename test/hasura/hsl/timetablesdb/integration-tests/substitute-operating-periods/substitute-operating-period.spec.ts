...
describe('substitute operating periods', () => {
  ...
  describe('insert substitute operating period', () => {
    ...
    it('should insert period and days by line type correctly', async () => {
      const inputData = [
        {
          is_preset: false,
    ...
    describe('overlapping time ranges for line types', () => {
      it('should fail when time ranges overlap with line type', async () => {
        const inputData = [
          {
            is_preset: false,
    ...
    describe('unique day of week', () => {
      it('should allow same day of week and type of line when time ranges do not overlap', async () => {
        const inputData = [
          {
            is_preset: false,
      ...
      it('should fail when superseded day and type of line are same but substitute day of week is different', async () => {
        const inputData = [
          {
            is_preset: false,
    ...
    describe('substitute day of week in range', () => {
      it('should fail when value is not in range', async () => {
        const inputData = [
          {
            is_preset: false,
    ...
    describe('time must be within the limits', () => {
      it('should fail when begin time is not within the time limits of the operating day', async () => {
        const inputData = [
          {
            is_preset: false,
      ...
      it('should fail when begin time is after end time', async () => {
        const inputData = [
          {
            is_preset: false,
            period_name: 'Begin time out of limits',
    ...
    it('should fail when end time is not within the time limits of the operating day', async () => {
      const inputData = [
        {
          is_preset: false,
