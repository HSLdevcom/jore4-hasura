...
export const temporarySatApril2023VehicleScheduleFrame = {
  ...buildHslVehicleScheduleFrame({
    ...
    name: 'Huhtikuun lauantait 2023',
    created_at: DateTime.fromISO('2021-01-01T02:34:56.789+02:00'),
  }),
};

export const temporarySatApril2023VehicleService = {
...
export const temporarySatApril2023VehicleServiceBlock = {
  block_id: '55ae7f82-b854-4875-bea8-3192e65f78ef',
  vehicle_service_id: temporarySatApril2023VehicleService.vehicle_service_id,
};

export const temporarySatApril2023VehicleJourneysByName = {
  v1journey1: {
    vehicle_journey_id: '34827909-ffe2-4e2e-a97d-d586dee6ea08',
    block_id: temporarySatApril2023VehicleServiceBlock.block_id,
...
export const temporarySatApril2023Dataset: TableData<HslTimetablesDbTables>[] =
  [
    {
      name: 'vehicle_schedule.vehicle_schedule_frame',
      data: [temporarySatApril2023VehicleScheduleFrame],
    },
    {
      name: 'vehicle_service.vehicle_service',
      data: [temporarySatApril2023VehicleService],
    },
    {
      name: 'vehicle_service.block',
      data: [temporarySatApril2023VehicleServiceBlock],
    },
    {
      name: 'vehicle_journey.vehicle_journey',
      data: [...Object.values(temporarySatApril2023VehicleJourneysByName)],
    },
  ];
