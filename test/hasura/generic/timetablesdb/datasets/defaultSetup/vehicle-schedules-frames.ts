...
export const vehicleScheduleFramesByName: Record<string, VehicleScheduleFrame> =
  {
...
export const vehicleScheduleFrames = Object.values(vehicleScheduleFramesByName);
