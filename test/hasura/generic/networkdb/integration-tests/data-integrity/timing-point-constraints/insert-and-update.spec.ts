...
describe('Inserting and updating scheduled_stop_point_on_journey_pattern with timing point constraint conflicts', () => {
...
describe('Inserting and updating scheduled_stop_point_on_journey_pattern without timing point constraint conflicts', () => {
  let dbConnection: DbConnection;
