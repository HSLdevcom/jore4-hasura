...
COMMENT ON COLUMN service_pattern.scheduled_stop_point.validity_start IS 'The point in time when the stop becomes valid. If NULL, the stop has been always valid.';
...
COMMENT ON COLUMN service_pattern.scheduled_stop_point.validity_end IS 'The point in time from which onwards the stop is no longer valid. If NULL, the stop will be always valid.';
...
1	{"metadata":true,"remote_schemas":[],"sources":["default"]}	3	612a73a1-9d76-4dc6-a450-5ab6360c42f5	2022-10-17 11:03:18.20829+00
\.
...
--
-- Data for Name: scheduled_stop_point; Type: TABLE DATA; Schema: internal_service_pattern; Owner: dbhasura
--

COPY internal_service_pattern.scheduled_stop_point (scheduled_stop_point_id, measured_location, located_on_infrastructure_link_id, direction, label, validity_start, validity_end, priority) FROM stdin;
\.


--
-- Data for Name: scheduled_stop_point_invariant; Type: TABLE DATA; Schema: internal_service_pattern; Owner: dbhasura
--

COPY internal_service_pattern.scheduled_stop_point_invariant (label) FROM stdin;
\.
