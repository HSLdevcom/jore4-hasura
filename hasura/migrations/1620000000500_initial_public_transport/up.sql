...
CREATE TABLE IF NOT EXISTS reusable_components.vehicle_submode (
...
CREATE TABLE IF NOT EXISTS infrastructure_network.infrastructure_link_safely_traversed_by_vehicle_submode (
