...
-- Ensure the dssview schema exists (in production it is created by the
-- infrastructure repository; in CI / test environments it may not exist yet).
CREATE SCHEMA IF NOT EXISTS dssview;

--------------------------------------------------------------------------------
-- Phase A: Simple pass-through views
