...
CREATE TABLE return_value.timetable_version (
  ...
  day_type_id uuid REFERENCES service_calendar.day_type(day_type_id) NULL
);

COMMENT ON TABLE return_value.timetable_version IS 'This return value is used for functions that determine what timetable versions are in effect.';
