CREATE OR REPLACE FUNCTION vehicle_service.get_timetables_and_substitute_operating_days(journey_pattern_ids uuid[], begin_date date, end_date date)
...
timetable_versions AS (
  ...
  vehicle_service.get_timetables_and_substitute_operating_days(journey_pattern_ids, begin_date, end_date
  )
)
 SELECT
