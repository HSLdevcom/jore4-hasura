...
DROP FUNCTION journey_pattern.queue_verify_infra_link_stop_refs_by_new_scheduled_stop_point_label();
...
DROP FUNCTION journey_pattern.create_queue_verify_infra_link_stop_refs_temp_table();
