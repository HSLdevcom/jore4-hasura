...
-- Extend the get_scheduled_stop_points_with_new -function to process a priority parameter
...
ALTER FUNCTION internal_service_pattern.get_scheduled_stop_points_with_new(
  ...
  RENAME TO get_scheduled_stop_points_with_new_1657795756608;
...
-- Extend the check_route_journey_pattern_refs -function to process a priority parameter
...
ALTER FUNCTION journey_pattern.check_route_journey_pattern_refs(
  ...
  RENAME TO check_route_journey_pattern_refs_1657795756608;
...
-- Extend the check_infra_link_stop_refs_with_new_scheduled_stop_point -function to process a priority parameter
...
ALTER FUNCTION journey_pattern.check_infra_link_stop_refs_with_new_scheduled_stop_point(
  ...
  RENAME TO check_infra_link_stop_refs_with_new_ssp_1657795756608;
