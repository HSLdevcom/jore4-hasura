...
CREATE OR REPLACE FUNCTION service_pattern.maybe_append_new_scheduled_stop_point(
...
AS $$
  ...
  WHERE
    ...
    END;
$$;
COMMENT ON FUNCTION service_pattern.maybe_append_new_scheduled_stop_point(new_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start date, new_validity_end date, new_priority integer)
