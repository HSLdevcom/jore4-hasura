...
COMMENT ON COLUMN internal_service_pattern.scheduled_stop_point_invariant.timing_point_id IS 'Optional reference to a TIMING POINT. If NULL, the scheduled stop point is not used for timing.';
