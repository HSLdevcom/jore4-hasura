...
CREATE FUNCTION route.delete_route_related_localizations ()
  RETURNS TRIGGER
  LANGUAGE plpgsql
...
CREATE TRIGGER internal_route_after_delete_route_trigger
  AFTER DELETE ON route.route FOR EACH ROW
  EXECUTE PROCEDURE route.delete_route_related_localizations();
