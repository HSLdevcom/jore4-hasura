...
CREATE FUNCTION internal_utils.next_day(
  bound date
)
  RETURNS date
  LANGUAGE sql
...
CREATE FUNCTION internal_utils.prev_day(
  bound date
)
  RETURNS date
  LANGUAGE sql
...
ALTER TABLE internal_service_pattern.scheduled_stop_point
  ALTER COLUMN validity_end TYPE date USING (validity_end - interval '1 day')::date;
