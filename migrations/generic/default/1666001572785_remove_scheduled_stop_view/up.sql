...
DROP TRIGGER service_pattern_delete_scheduled_stop_point_trigger
  ON service_pattern.scheduled_stop_point_to_be_deleted;
...
CREATE TRIGGER service_pattern_delete_scheduled_stop_point_trigger
  AFTER DELETE ON service_pattern.scheduled_stop_point
  FOR EACH ROW EXECUTE FUNCTION service_pattern.on_delete_scheduled_stop_point();
...
CREATE TRIGGER service_pattern_insert_scheduled_stop_point_trigger
  BEFORE INSERT ON service_pattern.scheduled_stop_point
  FOR EACH ROW EXECUTE FUNCTION service_pattern.on_insert_scheduled_stop_point();
...
CREATE TRIGGER service_pattern_update_scheduled_stop_point_trigger
  BEFORE UPDATE ON service_pattern.scheduled_stop_point
  FOR EACH ROW EXECUTE FUNCTION service_pattern.on_update_scheduled_stop_point();
