...
DROP FUNCTION service_pattern.on_delete_scheduled_stop_point();
...
DROP FUNCTION service_pattern.on_insert_scheduled_stop_point();
...
DROP FUNCTION service_pattern.on_update_scheduled_stop_point();
...
CREATE TRIGGER service_pattern_delete_scheduled_stop_point_trigger
  INSTEAD OF DELETE ON service_pattern.scheduled_stop_point FOR EACH ROW
  EXECUTE FUNCTION service_pattern.delete_scheduled_stop_point();
CREATE TRIGGER service_pattern_insert_scheduled_stop_point_trigger
  INSTEAD OF INSERT ON service_pattern.scheduled_stop_point FOR EACH ROW
  EXECUTE FUNCTION service_pattern.insert_scheduled_stop_point();
CREATE TRIGGER service_pattern_update_scheduled_stop_point_trigger
  INSTEAD OF UPDATE ON service_pattern.scheduled_stop_point FOR EACH ROW
  EXECUTE FUNCTION service_pattern.update_scheduled_stop_point();
