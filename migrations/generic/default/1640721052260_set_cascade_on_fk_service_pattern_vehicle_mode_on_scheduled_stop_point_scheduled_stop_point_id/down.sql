ALTER TABLE service_pattern.vehicle_mode_on_scheduled_stop_point
  DROP CONSTRAINT vehicle_mode_on_scheduled_stop_point_scheduled_stop_point_id_fkey,
  ADD CONSTRAINT scheduled_stop_point_serviced_by_v_scheduled_stop_point_id_fkey
