...
VALUES
  ('6781bd06-08cf-489e-a2bb-be9a07b15752','MT','{"fi_FI": "Maanantai - Torstai", "sv_FI": "Måndag - Torsdag"}'),
  ('38853b0d-ec36-4110-b4bc-f53218c6cdcd','MP','{"fi_FI": "Maanantai - Perjantai", "sv_FI": "Måndag - Fredag"}'),
  ('7176e238-d46e-4583-a567-b836b1ae2589','PE','{"fi_FI": "Perjantai", "sv_FI": "Fredag"}'),
...
COMMENT ON COLUMN passing_times.timetabled_passing_time.arrival_time IS 'The time when the vehicle arrives to the SCHEDULED STOP POINT. Measured as interval counted from the midnight of the OPERATING DAY. When NULL, the vehicle does not need to wait at the stop but may continue its journey immediately';
