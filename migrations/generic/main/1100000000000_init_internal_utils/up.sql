...
CREATE OR REPLACE FUNCTION internal_utils.const_priority_staging() RETURNS integer
    LANGUAGE sql IMMUTABLE PARALLEL SAFE
    AS $$SELECT 40$$;

CREATE OR REPLACE FUNCTION internal_utils.const_priority_special() RETURNS integer
    LANGUAGE sql IMMUTABLE PARALLEL SAFE
    AS $$SELECT 25$$;
