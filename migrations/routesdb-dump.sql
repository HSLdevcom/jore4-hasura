...
CREATE FUNCTION service_pattern.get_distances_between_stop_points_for_journey_patterns(route_ids uuid[], route_priority integer, observation_date date) RETURNS SETOF service_pattern.stop_interval_length
    LANGUAGE sql STABLE PARALLEL SAFE
    AS $$
SELECT
