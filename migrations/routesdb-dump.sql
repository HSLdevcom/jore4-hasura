...
--
-- Name: FUNCTION get_distances_between_stop_points_by_routes(route_ids uuid[], route_priority integer, observation_date date); Type: COMMENT; Schema: service_pattern; Owner: dbhasura
--

COMMENT ON FUNCTION service_pattern.get_distances_between_stop_points_by_routes(route_ids uuid[], route_priority integer, observation_date date) IS 'Get the distances between scheduled stop points (in metres) for the journey/service patterns resolved from the route identifiers.';
...
--
-- Name: get_distances_between_stop_points_by_routes(uuid[], integer, date); Type: FUNCTION; Schema: service_pattern; Owner: dbhasura
--

CREATE FUNCTION service_pattern.get_distances_between_stop_points_by_routes(route_ids uuid[], route_priority integer, observation_date date) RETURNS SETOF service_pattern.distance_between_stops_calculation
    LANGUAGE sql STABLE PARALLEL SAFE
    AS $$
...
ALTER FUNCTION service_pattern.get_distances_between_stop_points_by_routes(route_ids uuid[], route_priority integer, observation_date date) OWNER TO dbhasura;
