...
--
-- Name: TABLE scheduled_stop_point_1666001572785; Type: ACL; Schema: deleted; Owner: dbhasura
--

GRANT SELECT ON TABLE deleted.scheduled_stop_point_1666001572785 TO dbimporter;
...
--
-- Name: COLUMN scheduled_stop_point_1666001572785.closest_point_on_infrastructure_link; Type: COMMENT; Schema: deleted; Owner: dbhasura
--

COMMENT ON COLUMN deleted.scheduled_stop_point_1666001572785.closest_point_on_infrastructure_link IS 'The point on the infrastructure link closest to measured_location. A PostGIS PointZ geography in EPSG:4326.';

--
-- Name: COLUMN scheduled_stop_point_1666001572785.direction; Type: COMMENT; Schema: deleted; Owner: dbhasura
--

COMMENT ON COLUMN deleted.scheduled_stop_point_1666001572785.direction IS 'The direction(s) of traffic with respect to the digitization, i.e. the direction of the specified LineString.';

--
-- Name: COLUMN scheduled_stop_point_1666001572785.label; Type: COMMENT; Schema: deleted; Owner: dbhasura
--

COMMENT ON COLUMN deleted.scheduled_stop_point_1666001572785.label IS 'The label is the short code that identifies the stop to the passengers. There can be at most one stop with the same label at a time. The label matches the GTFS stop_code.';

--
-- Name: COLUMN scheduled_stop_point_1666001572785.located_on_infrastructure_link_id; Type: COMMENT; Schema: deleted; Owner: dbhasura
--

COMMENT ON COLUMN deleted.scheduled_stop_point_1666001572785.located_on_infrastructure_link_id IS 'The infrastructure link on which the stop is located.';

--
-- Name: COLUMN scheduled_stop_point_1666001572785.measured_location; Type: COMMENT; Schema: deleted; Owner: dbhasura
--

COMMENT ON COLUMN deleted.scheduled_stop_point_1666001572785.measured_location IS 'The measured location describes the physical location of the stop. For some stops this describes the location of the pole-mounted flag. A PostGIS PointZ geography in EPSG:4326.';

--
-- Name: COLUMN scheduled_stop_point_1666001572785.priority; Type: COMMENT; Schema: deleted; Owner: dbhasura
--

COMMENT ON COLUMN deleted.scheduled_stop_point_1666001572785.priority IS 'The priority of the stop definition. The definition may be overridden by higher priority definitions.';

--
-- Name: COLUMN scheduled_stop_point_1666001572785.relative_distance_from_infrastructure_link_start; Type: COMMENT; Schema: deleted; Owner: dbhasura
--

COMMENT ON COLUMN deleted.scheduled_stop_point_1666001572785.relative_distance_from_infrastructure_link_start IS 'The relative distance of the stop from the start of the linestring along the infrastructure link. Regardless of the specified direction, this value is the distance from the beginning of the linestring. The distance is normalized to the closed interval [0, 1].';

--
-- Name: COLUMN scheduled_stop_point_1666001572785.scheduled_stop_point_id; Type: COMMENT; Schema: deleted; Owner: dbhasura
--

COMMENT ON COLUMN deleted.scheduled_stop_point_1666001572785.scheduled_stop_point_id IS 'The ID of the scheduled stop point.';

--
-- Name: COLUMN scheduled_stop_point_1666001572785.validity_end; Type: COMMENT; Schema: deleted; Owner: dbhasura
--

COMMENT ON COLUMN deleted.scheduled_stop_point_1666001572785.validity_end IS 'The date from which onwards the stop is no longer valid. If NULL, the stop will be always valid.';

--
-- Name: COLUMN scheduled_stop_point_1666001572785.validity_start; Type: COMMENT; Schema: deleted; Owner: dbhasura
--

COMMENT ON COLUMN deleted.scheduled_stop_point_1666001572785.validity_start IS 'The date when the stop becomes valid. If NULL, the stop has been always valid.';

--
-- Name: FUNCTION check_infra_link_stop_refs_with_new_ssp_1657795756608(replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone); Type: COMMENT; Schema: deleted; Owner: dbhasura
--

COMMENT ON FUNCTION deleted.check_infra_link_stop_refs_with_new_ssp_1657795756608(replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone) IS 'Check whether the journey pattern''s / route''s links and stop points still correspond to each other
...
--
-- Name: FUNCTION check_infra_link_stop_refs_with_new_ssp_1657873981408(replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer); Type: COMMENT; Schema: deleted; Owner: dbhasura
--

COMMENT ON FUNCTION deleted.check_infra_link_stop_refs_with_new_ssp_1657873981408(replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer) IS 'Check whether the journey pattern''s / route''s links and stop points still correspond to each other
     if a new stop point would be inserted (defined by arguments new_xxx). If
     replace_scheduled_stop_point_id is specified, the new stop point is thought to replace the stop point
     with that ID.
     This function returns a list of journey pattern and route ids, in which the links
...
--
-- Name: FUNCTION check_infra_link_stop_refs_with_new_ssp_1661150118779(replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer); Type: COMMENT; Schema: deleted; Owner: dbhasura
--

COMMENT ON FUNCTION deleted.check_infra_link_stop_refs_with_new_ssp_1661150118779(replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer) IS 'Check whether the journey pattern''s / route''s links and stop points still correspond to each other
     if a new stop point would be inserted (defined by arguments new_xxx). If
     replace_scheduled_stop_point_id is specified, the new stop point is thought to replace the stop point
     with that ID.
     This function returns a list of journey pattern and route ids, in which the links
...
--
-- Name: FUNCTION check_infra_link_stop_refs_with_new_ssp_1661496355072(replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer); Type: COMMENT; Schema: deleted; Owner: dbhasura
--

COMMENT ON FUNCTION deleted.check_infra_link_stop_refs_with_new_ssp_1661496355072(replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer) IS 'Check whether the journey pattern''s / route''s links and stop points still correspond to each other
     if a new stop point would be inserted (defined by arguments new_xxx). If
     replace_scheduled_stop_point_id is specified, the new stop point is thought to replace the stop point
     with that ID.
     This function returns a list of journey pattern and route ids, in which the links
...
--
-- Name: FUNCTION check_infra_link_stop_refs_with_new_ssp_1664191395447(replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer); Type: COMMENT; Schema: deleted; Owner: dbhasura
--

COMMENT ON FUNCTION deleted.check_infra_link_stop_refs_with_new_ssp_1664191395447(replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer) IS 'Check whether the journey pattern''s / route''s links and stop points still correspond to each other
...
--
-- Name: FUNCTION check_route_journey_pattern_refs_1657094681412(filter_journey_pattern_id uuid, filter_route_id uuid, replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone); Type: COMMENT; Schema: deleted; Owner: dbhasura
--

COMMENT ON FUNCTION deleted.check_route_journey_pattern_refs_1657094681412(filter_journey_pattern_id uuid, filter_route_id uuid, replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone) IS 'Check if it is possible to visit all stops of a journey pattern in such a fashion that all links, on which
...
--
-- Name: FUNCTION check_route_journey_pattern_refs_1657795756608(filter_journey_pattern_id uuid, filter_route_id uuid, replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone); Type: COMMENT; Schema: deleted; Owner: dbhasura
--

COMMENT ON FUNCTION deleted.check_route_journey_pattern_refs_1657795756608(filter_journey_pattern_id uuid, filter_route_id uuid, replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone) IS 'Check if it is possible to visit all stops of a journey pattern in such a fashion that all links, on which
   the stops reside, are visited in an order matching the route''s link order.
...
--
-- Name: FUNCTION check_route_journey_pattern_refs_1657873981408(filter_journey_pattern_id uuid, filter_route_id uuid, replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer); Type: COMMENT; Schema: deleted; Owner: dbhasura
--

COMMENT ON FUNCTION deleted.check_route_journey_pattern_refs_1657873981408(filter_journey_pattern_id uuid, filter_route_id uuid, replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer) IS 'Check if it is possible to visit all stops of a journey pattern in such a fashion that all links, on which
     the stops reside, are visited in an order matching the route''s link order.
...
--
-- Name: FUNCTION check_route_journey_pattern_refs_1661496355072(filter_journey_pattern_id uuid, filter_route_id uuid, replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer); Type: COMMENT; Schema: deleted; Owner: dbhasura
--

COMMENT ON FUNCTION deleted.check_route_journey_pattern_refs_1661496355072(filter_journey_pattern_id uuid, filter_route_id uuid, replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer) IS 'Check if it is possible to visit all stops of a journey pattern in such a fashion that all links, on which
     the stops reside, are visited in an order matching the route''s link order.
...
--
-- Name: FUNCTION create_verify_infra_link_stop_refs_queue_temp_t_1661496355072(); Type: COMMENT; Schema: deleted; Owner: dbhasura
--

COMMENT ON FUNCTION deleted.create_verify_infra_link_stop_refs_queue_temp_t_1661496355072() IS '''Create the temp table used to enqueue verification of the changed journey patterns and routes from
  statement-level triggers''';

--
-- Name: FUNCTION get_broken_route_check_filters_1664191395447(filter_route_ids uuid[]); Type: COMMENT; Schema: deleted; Owner: dbhasura
--

COMMENT ON FUNCTION deleted.get_broken_route_check_filters_1664191395447(filter_route_ids uuid[]) IS 'Gather the filter parameters (route labels and validity range to check) for the broken route check.';

--
-- Name: FUNCTION get_broken_route_journey_patterns_1664191395447(filter_route_ids uuid[], replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer); Type: COMMENT; Schema: deleted; Owner: dbhasura
--

COMMENT ON FUNCTION deleted.get_broken_route_journey_patterns_1664191395447(filter_route_ids uuid[], replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer) IS 'Check if it is possible to visit all stops of journey patterns in such a fashion that all links, on which
...
--
-- Name: FUNCTION maximum_priority_validity_spans_1661496355072(entity_type text, filter_validity_start timestamp with time zone, filter_validity_end timestamp with time zone, upper_priority_limit integer, replace_scheduled_stop_point_id uuid, new_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer); Type: COMMENT; Schema: deleted; Owner: dbhasura
--

COMMENT ON FUNCTION deleted.maximum_priority_validity_spans_1661496355072(entity_type text, filter_validity_start timestamp with time zone, filter_validity_end timestamp with time zone, upper_priority_limit integer, replace_scheduled_stop_point_id uuid, new_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer) IS 'Find the validity time spans of highest priority in the given time span for entities of the given type (routes or
...
--
-- Name: FUNCTION maximum_priority_validity_spans_1664191395447(entity_type text, filter_route_labels text[], filter_validity_start timestamp with time zone, filter_validity_end timestamp with time zone, upper_priority_limit integer, replace_scheduled_stop_point_id uuid, new_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer); Type: COMMENT; Schema: deleted; Owner: dbhasura
--

COMMENT ON FUNCTION deleted.maximum_priority_validity_spans_1664191395447(entity_type text, filter_route_labels text[], filter_validity_start timestamp with time zone, filter_validity_end timestamp with time zone, upper_priority_limit integer, replace_scheduled_stop_point_id uuid, new_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer) IS 'Find the validity time spans of highest priority in the given time span for entities of the given type (routes or
...
--
-- Name: FUNCTION verify_infra_link_stop_refs_1661496355072(); Type: COMMENT; Schema: deleted; Owner: dbhasura
--
...
--
-- Name: VIEW scheduled_stop_point_1666001572785; Type: COMMENT; Schema: deleted; Owner: dbhasura
--

COMMENT ON VIEW deleted.scheduled_stop_point_1666001572785 IS 'The scheduled stop points: https://www.transmodel-cen.eu/model/index.htm?goto=2:3:4:845 . Colloquially known as stops from the perspective of timetable planning.';
...
CREATE FUNCTION deleted.check_infra_link_stop_refs_with_new_ssp_1657795756608(replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone) RETURNS SETOF journey_pattern.journey_pattern
    LANGUAGE sql STABLE
    AS $$
SELECT jp.*
...
ALTER FUNCTION deleted.check_infra_link_stop_refs_with_new_ssp_1657795756608(replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone) OWNER TO dbhasura;

--
-- Name: check_infra_link_stop_refs_with_new_ssp_1657873981408(uuid, uuid, public.geography, text, text, timestamp with time zone, timestamp with time zone, integer); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.check_infra_link_stop_refs_with_new_ssp_1657873981408(replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer) RETURNS SETOF journey_pattern.journey_pattern
    LANGUAGE sql STABLE
    AS $$
SELECT jp.*
FROM journey_pattern.journey_pattern jp
...
ALTER FUNCTION deleted.check_infra_link_stop_refs_with_new_ssp_1657873981408(replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer) OWNER TO dbhasura;

--
-- Name: check_infra_link_stop_refs_with_new_ssp_1661150118779(uuid, uuid, public.geography, text, text, timestamp with time zone, timestamp with time zone, integer); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.check_infra_link_stop_refs_with_new_ssp_1661150118779(replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer) RETURNS SETOF journey_pattern.journey_pattern
    LANGUAGE sql STABLE
    AS $$
SELECT DISTINCT jp.*
FROM journey_pattern.journey_pattern jp
...
ALTER FUNCTION deleted.check_infra_link_stop_refs_with_new_ssp_1661150118779(replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer) OWNER TO dbhasura;

--
-- Name: check_infra_link_stop_refs_with_new_ssp_1661496355072(uuid, uuid, public.geography, text, text, timestamp with time zone, timestamp with time zone, integer); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.check_infra_link_stop_refs_with_new_ssp_1661496355072(replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer) RETURNS SETOF journey_pattern.journey_pattern
...
ALTER FUNCTION deleted.check_infra_link_stop_refs_with_new_ssp_1661496355072(replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer) OWNER TO dbhasura;

--
-- Name: check_infra_link_stop_refs_with_new_ssp_1664191395447(uuid, uuid, public.geography, text, text, timestamp with time zone, timestamp with time zone, integer); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.check_infra_link_stop_refs_with_new_ssp_1664191395447(replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer) RETURNS SETOF journey_pattern.journey_pattern
...
ALTER FUNCTION deleted.check_infra_link_stop_refs_with_new_ssp_1664191395447(replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer) OWNER TO dbhasura;

--
-- Name: check_route_journey_pattern_refs_1657094681412(uuid, uuid, uuid, uuid, public.geography, text, text, timestamp with time zone, timestamp with time zone); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.check_route_journey_pattern_refs_1657094681412(filter_journey_pattern_id uuid, filter_route_id uuid, replace_scheduled_stop_point_id uuid DEFAULT NULL::uuid, new_located_on_infrastructure_link_id uuid DEFAULT NULL::uuid, new_measured_location public.geography DEFAULT NULL::public.geography, new_direction text DEFAULT NULL::text, new_label text DEFAULT NULL::text, new_validity_start timestamp with time zone DEFAULT NULL::timestamp with time zone, new_validity_end timestamp with time zone DEFAULT NULL::timestamp with time zone) RETURNS boolean
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER FUNCTION deleted.check_route_journey_pattern_refs_1657094681412(filter_journey_pattern_id uuid, filter_route_id uuid, replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone) OWNER TO dbhasura;

--
-- Name: check_route_journey_pattern_refs_1657795756608(uuid, uuid, uuid, uuid, public.geography, text, text, timestamp with time zone, timestamp with time zone); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.check_route_journey_pattern_refs_1657795756608(filter_journey_pattern_id uuid, filter_route_id uuid, replace_scheduled_stop_point_id uuid DEFAULT NULL::uuid, new_located_on_infrastructure_link_id uuid DEFAULT NULL::uuid, new_measured_location public.geography DEFAULT NULL::public.geography, new_direction text DEFAULT NULL::text, new_label text DEFAULT NULL::text, new_validity_start timestamp with time zone DEFAULT NULL::timestamp with time zone, new_validity_end timestamp with time zone DEFAULT NULL::timestamp with time zone) RETURNS boolean
    LANGUAGE plpgsql
    AS $$
DECLARE
  new_scheduled_stop_point_id UUID DEFAULT NULL;
...
--
-- Name: check_route_journey_pattern_refs_1657873981408(uuid, uuid, uuid, uuid, public.geography, text, text, timestamp with time zone, timestamp with time zone, integer); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.check_route_journey_pattern_refs_1657873981408(filter_journey_pattern_id uuid, filter_route_id uuid, replace_scheduled_stop_point_id uuid DEFAULT NULL::uuid, new_located_on_infrastructure_link_id uuid DEFAULT NULL::uuid, new_measured_location public.geography DEFAULT NULL::public.geography, new_direction text DEFAULT NULL::text, new_label text DEFAULT NULL::text, new_validity_start timestamp with time zone DEFAULT NULL::timestamp with time zone, new_validity_end timestamp with time zone DEFAULT NULL::timestamp with time zone, new_priority integer DEFAULT NULL::integer) RETURNS boolean
    LANGUAGE plpgsql
    AS $$
DECLARE
  new_scheduled_stop_point_id UUID DEFAULT NULL;
    ...
    FROM (
           WITH RECURSIVE
             ...
             sspijp_ilar_combos AS (
               ...
               WHERE (jp.journey_pattern_id = filter_journey_pattern_id
                    OR r.route_id = filter_route_id)
                 AND r.priority < internal_utils.const_priority_draft()
...
ALTER FUNCTION deleted.check_route_journey_pattern_refs_1657873981408(filter_journey_pattern_id uuid, filter_route_id uuid, replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer) OWNER TO dbhasura;

--
-- Name: check_route_journey_pattern_refs_1661496355072(uuid, uuid, uuid, uuid, public.geography, text, text, timestamp with time zone, timestamp with time zone, integer); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.check_route_journey_pattern_refs_1661496355072(filter_journey_pattern_id uuid, filter_route_id uuid, replace_scheduled_stop_point_id uuid DEFAULT NULL::uuid, new_located_on_infrastructure_link_id uuid DEFAULT NULL::uuid, new_measured_location public.geography DEFAULT NULL::public.geography, new_direction text DEFAULT NULL::text, new_label text DEFAULT NULL::text, new_validity_start timestamp with time zone DEFAULT NULL::timestamp with time zone, new_validity_end timestamp with time zone DEFAULT NULL::timestamp with time zone, new_priority integer DEFAULT NULL::integer) RETURNS boolean
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: check_route_validity_is_within_line_validity_1664191395447(); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.check_route_validity_is_within_line_validity_1664191395447() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER FUNCTION deleted.check_route_validity_is_within_line_validity_1664191395447() OWNER TO dbhasura;

--
-- Name: create_verify_infra_link_stop_refs_queue_temp_t_1661496355072(); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.create_verify_infra_link_stop_refs_queue_temp_t_1661496355072() RETURNS void
    LANGUAGE sql
    AS $$
...
ALTER FUNCTION deleted.create_verify_infra_link_stop_refs_queue_temp_t_1661496355072() OWNER TO dbhasura;

--
-- Name: delete_scheduled_stop_point_1651476243443(); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.delete_scheduled_stop_point_1651476243443() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION deleted.delete_scheduled_stop_point_1651476243443() OWNER TO dbhasura;

--
-- Name: get_broken_route_check_filters_1664191395447(uuid[]); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.get_broken_route_check_filters_1664191395447(filter_route_ids uuid[]) RETURNS TABLE(labels text[], validity_start timestamp with time zone, validity_end timestamp with time zone)
    LANGUAGE sql STABLE PARALLEL SAFE
    AS $$
WITH RECURSIVE
  route_param AS (
...
ALTER FUNCTION deleted.get_broken_route_check_filters_1664191395447(filter_route_ids uuid[]) OWNER TO dbhasura;

--
-- Name: get_broken_route_journey_patterns_1664191395447(uuid[], uuid, uuid, public.geography, text, text, timestamp with time zone, timestamp with time zone, integer); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.get_broken_route_journey_patterns_1664191395447(filter_route_ids uuid[], replace_scheduled_stop_point_id uuid DEFAULT NULL::uuid, new_located_on_infrastructure_link_id uuid DEFAULT NULL::uuid, new_measured_location public.geography DEFAULT NULL::public.geography, new_direction text DEFAULT NULL::text, new_label text DEFAULT NULL::text, new_validity_start timestamp with time zone DEFAULT NULL::timestamp with time zone, new_validity_end timestamp with time zone DEFAULT NULL::timestamp with time zone, new_priority integer DEFAULT NULL::integer) RETURNS SETOF journey_pattern.journey_pattern
    LANGUAGE sql STABLE PARALLEL SAFE
    AS $$
WITH RECURSIVE
  new_ssp_param AS (
...
ALTER FUNCTION deleted.get_broken_route_journey_patterns_1664191395447(filter_route_ids uuid[], replace_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer) OWNER TO dbhasura;

--
-- Name: insert_route_1637329168554(); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.insert_route_1637329168554() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION deleted.insert_route_1637329168554() OWNER TO dbhasura;

--
-- Name: insert_scheduled_stop_point_1651476243443(); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.insert_scheduled_stop_point_1651476243443() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION deleted.insert_scheduled_stop_point_1651476243443() OWNER TO dbhasura;

--
-- Name: insert_scheduled_stop_point_1654783185212(); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.insert_scheduled_stop_point_1654783185212() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION deleted.insert_scheduled_stop_point_1654783185212() OWNER TO dbhasura;

--
-- Name: insert_scheduled_stop_point_1654783185212(uuid, public.geography, uuid, text, text, timestamp with time zone, timestamp with time zone, integer, text); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.insert_scheduled_stop_point_1654783185212(scheduled_stop_point_id uuid, measured_location public.geography, located_on_infrastructure_link_id uuid, direction text, label text, validity_start timestamp with time zone, validity_end timestamp with time zone, priority integer, supported_vehicle_mode text) RETURNS void
    LANGUAGE plpgsql
    AS $$
    BEGIN
        INSERT INTO internal_service_pattern.scheduled_stop_point (
...
ALTER FUNCTION deleted.insert_scheduled_stop_point_1654783185212(scheduled_stop_point_id uuid, measured_location public.geography, located_on_infrastructure_link_id uuid, direction text, label text, validity_start timestamp with time zone, validity_end timestamp with time zone, priority integer, supported_vehicle_mode text) OWNER TO dbhasura;

--
-- Name: insert_scheduled_stop_point_with_vehicle_mode_1664191395447(uuid, public.geography, uuid, text, text, timestamp with time zone, timestamp with time zone, integer, text); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.insert_scheduled_stop_point_with_vehicle_mode_1664191395447(scheduled_stop_point_id uuid, measured_location public.geography, located_on_infrastructure_link_id uuid, direction text, label text, validity_start timestamp with time zone, validity_end timestamp with time zone, priority integer, supported_vehicle_mode text) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION deleted.insert_scheduled_stop_point_with_vehicle_mode_1664191395447(scheduled_stop_point_id uuid, measured_location public.geography, located_on_infrastructure_link_id uuid, direction text, label text, validity_start timestamp with time zone, validity_end timestamp with time zone, priority integer, supported_vehicle_mode text) OWNER TO dbhasura;

--
-- Name: maximum_priority_validity_spans_1661496355072(text, timestamp with time zone, timestamp with time zone, integer, uuid, uuid, uuid, public.geography, text, text, timestamp with time zone, timestamp with time zone, integer); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.maximum_priority_validity_spans_1661496355072(entity_type text, filter_validity_start timestamp with time zone DEFAULT NULL::timestamp with time zone, filter_validity_end timestamp with time zone DEFAULT NULL::timestamp with time zone, upper_priority_limit integer DEFAULT NULL::integer, replace_scheduled_stop_point_id uuid DEFAULT NULL::uuid, new_scheduled_stop_point_id uuid DEFAULT NULL::uuid, new_located_on_infrastructure_link_id uuid DEFAULT NULL::uuid, new_measured_location public.geography DEFAULT NULL::public.geography, new_direction text DEFAULT NULL::text, new_label text DEFAULT NULL::text, new_validity_start timestamp with time zone DEFAULT NULL::timestamp with time zone, new_validity_end timestamp with time zone DEFAULT NULL::timestamp with time zone, new_priority integer DEFAULT NULL::integer) RETURNS TABLE(id uuid, validity_start timestamp with time zone, validity_end timestamp with time zone)
    LANGUAGE sql STABLE
    AS $$
WITH RECURSIVE
  entity AS (
...
ALTER FUNCTION deleted.maximum_priority_validity_spans_1661496355072(entity_type text, filter_validity_start timestamp with time zone, filter_validity_end timestamp with time zone, upper_priority_limit integer, replace_scheduled_stop_point_id uuid, new_scheduled_stop_point_id uuid, new_located_on_infrastructure_link_id uuid, new_measured_location public.geography, new_direction text, new_label text, new_validity_start timestamp with time zone, new_validity_end timestamp with time zone, new_priority integer) OWNER TO dbhasura;

--
-- Name: maximum_priority_validity_spans_1664191395447(text, text[], timestamp with time zone, timestamp with time zone, integer, uuid, uuid, uuid, public.geography, text, text, timestamp with time zone, timestamp with time zone, integer); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.maximum_priority_validity_spans_1664191395447(entity_type text, filter_route_labels text[], filter_validity_start timestamp with time zone DEFAULT NULL::timestamp with time zone, filter_validity_end timestamp with time zone DEFAULT NULL::timestamp with time zone, upper_priority_limit integer DEFAULT NULL::integer, replace_scheduled_stop_point_id uuid DEFAULT NULL::uuid, new_scheduled_stop_point_id uuid DEFAULT NULL::uuid, new_located_on_infrastructure_link_id uuid DEFAULT NULL::uuid, new_measured_location public.geography DEFAULT NULL::public.geography, new_direction text DEFAULT NULL::text, new_label text DEFAULT NULL::text, new_validity_start timestamp with time zone DEFAULT NULL::timestamp with time zone, new_validity_end timestamp with time zone DEFAULT NULL::timestamp with time zone, new_priority integer DEFAULT NULL::integer) RETURNS TABLE(id uuid, validity_start timestamp with time zone, validity_end timestamp with time zone)
    LANGUAGE sql STABLE PARALLEL SAFE
    AS $$
WITH RECURSIVE
...
--
-- Name: queue_verify_infra_link_stop_refs_by_new_jp_id_1661496355072(); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.queue_verify_infra_link_stop_refs_by_new_jp_id_1661496355072() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION deleted.queue_verify_infra_link_stop_refs_by_new_jp_id_1661496355072() OWNER TO dbhasura;

--
-- Name: queue_verify_infra_link_stop_refs_by_new_jp_id_1664191395447(); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.queue_verify_infra_link_stop_refs_by_new_jp_id_1664191395447() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
  -- RAISE NOTICE 'journey_pattern.queue_verify_infra_link_stop_refs_by_new_journey_pattern_id()';
...
ALTER FUNCTION deleted.queue_verify_infra_link_stop_refs_by_new_jp_id_1664191395447() OWNER TO dbhasura;

--
-- Name: queue_verify_infra_link_stop_refs_by_new_ssp_l_1661496355072(); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.queue_verify_infra_link_stop_refs_by_new_ssp_l_1661496355072() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION deleted.queue_verify_infra_link_stop_refs_by_new_ssp_l_1661496355072() OWNER TO dbhasura;

--
-- Name: queue_verify_infra_link_stop_refs_by_new_ssp_l_1664191395447(); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.queue_verify_infra_link_stop_refs_by_new_ssp_l_1664191395447() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
  -- RAISE NOTICE 'journey_pattern.queue_verify_infra_link_stop_refs_by_new_ssp_label()';
...
ALTER FUNCTION deleted.queue_verify_infra_link_stop_refs_by_new_ssp_l_1664191395447() OWNER TO dbhasura;

--
-- Name: queue_verify_infra_link_stop_refs_by_old_route_id_1661496355072(); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.queue_verify_infra_link_stop_refs_by_old_route_id_1661496355072() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION deleted.queue_verify_infra_link_stop_refs_by_old_route_id_1661496355072() OWNER TO dbhasura;

--
-- Name: queue_verify_infra_link_stop_refs_by_old_route_id_1664191395447(); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.queue_verify_infra_link_stop_refs_by_old_route_id_1664191395447() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
  -- RAISE NOTICE 'journey_pattern.queue_verify_infra_link_stop_refs_by_old_route_id()';
...
ALTER FUNCTION deleted.queue_verify_infra_link_stop_refs_by_old_route_id_1664191395447() OWNER TO dbhasura;

--
-- Name: queue_verify_infra_link_stop_refs_by_old_route_l_1664191395447(); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.queue_verify_infra_link_stop_refs_by_old_route_l_1664191395447() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION deleted.queue_verify_infra_link_stop_refs_by_old_route_l_1664191395447() OWNER TO dbhasura;

--
-- Name: queue_verify_infra_link_stop_refs_by_old_ssp_l_1664191395447(); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.queue_verify_infra_link_stop_refs_by_old_ssp_l_1664191395447() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION deleted.queue_verify_infra_link_stop_refs_by_old_ssp_l_1664191395447() OWNER TO dbhasura;

--
-- Name: queue_verify_infra_link_stop_refs_by_other_jp_ids_1661496355072(); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.queue_verify_infra_link_stop_refs_by_other_jp_ids_1661496355072() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION deleted.queue_verify_infra_link_stop_refs_by_other_jp_ids_1661496355072() OWNER TO dbhasura;

--
-- Name: queue_verify_infra_link_stop_refs_by_other_r_ids_1661496355072(); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.queue_verify_infra_link_stop_refs_by_other_r_ids_1661496355072() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION deleted.queue_verify_infra_link_stop_refs_by_other_r_ids_1661496355072() OWNER TO dbhasura;

--
-- Name: route_shape_1660903023968(route.route); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.route_shape_1660903023968(route_row route.route) RETURNS public.geography
    LANGUAGE sql STABLE
    AS $$
  SELECT
    ST_LineMerge(
...
ALTER FUNCTION deleted.route_shape_1660903023968(route_row route.route) OWNER TO dbhasura;

--
-- Name: update_route_1637329168554(); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.update_route_1637329168554() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION deleted.update_route_1637329168554() OWNER TO dbhasura;

--
-- Name: update_scheduled_stop_point_1651476243443(); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.update_scheduled_stop_point_1651476243443() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION deleted.update_scheduled_stop_point_1651476243443() OWNER TO dbhasura;

--
-- Name: verify_infra_link_stop_refs_1661496355072(); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.verify_infra_link_stop_refs_1661496355072() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER FUNCTION deleted.verify_infra_link_stop_refs_1661496355072() OWNER TO dbhasura;

--
-- Name: verify_infra_link_stop_refs_by_new_journey_pattern_id_165598648(); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.verify_infra_link_stop_refs_by_new_journey_pattern_id_165598648() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION deleted.verify_infra_link_stop_refs_by_new_journey_pattern_id_165598648() OWNER TO dbhasura;

--
-- Name: verify_infra_link_stop_refs_by_new_ssp_1649847021000(); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.verify_infra_link_stop_refs_by_new_ssp_1649847021000() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
  journey_pattern_id UUID;
...
ALTER FUNCTION deleted.verify_infra_link_stop_refs_by_new_ssp_1649847021000() OWNER TO dbhasura;

--
-- Name: verify_infra_link_stop_refs_by_new_ssp_1655986484186(); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.verify_infra_link_stop_refs_by_new_ssp_1655986484186() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
  journey_pattern_id UUID;
...
ALTER FUNCTION deleted.verify_infra_link_stop_refs_by_new_ssp_1655986484186() OWNER TO dbhasura;

--
-- Name: verify_infra_link_stop_refs_by_old_route_id_1655986484186(); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.verify_infra_link_stop_refs_by_old_route_id_1655986484186() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION deleted.verify_infra_link_stop_refs_by_old_route_id_1655986484186() OWNER TO dbhasura;

--
-- Name: verify_route_journey_pattern_refs_1649661919181(uuid, uuid); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.verify_route_journey_pattern_refs_1649661919181(filter_journey_pattern_id uuid, filter_route_id uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
  -- Check if it is possible to visit all stops of a journey pattern in such a fashion that all links, on which
...
ALTER FUNCTION deleted.verify_route_journey_pattern_refs_1649661919181(filter_journey_pattern_id uuid, filter_route_id uuid) OWNER TO dbhasura;

--
-- Name: verify_route_start_end_stop_points_1652770377314(uuid); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.verify_route_start_end_stop_points_1652770377314(param_route_id uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
  IF (
...
ALTER FUNCTION deleted.verify_route_start_end_stop_points_1652770377314(param_route_id uuid) OWNER TO dbhasura;

--
-- Name: verify_route_start_end_stop_points_by_new_route_id_165277037731(); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.verify_route_start_end_stop_points_by_new_route_id_165277037731() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION deleted.verify_route_start_end_stop_points_by_new_route_id_165277037731() OWNER TO dbhasura;

--
-- Name: verify_route_start_end_stop_points_by_old_and_new_link_id_16527(); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.verify_route_start_end_stop_points_by_old_and_new_link_id_16527() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
  route_id UUID;
...
ALTER FUNCTION deleted.verify_route_start_end_stop_points_by_old_and_new_link_id_16527() OWNER TO dbhasura;

--
-- Name: verify_route_start_end_stop_points_by_old_and_new_route_id_1652(); Type: FUNCTION; Schema: deleted; Owner: dbhasura
--

CREATE FUNCTION deleted.verify_route_start_end_stop_points_by_old_and_new_route_id_1652() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION deleted.verify_route_start_end_stop_points_by_old_and_new_route_id_1652() OWNER TO dbhasura;
...
--
-- Name: deleted; Type: SCHEMA; Schema: -; Owner: dbhasura
--

CREATE SCHEMA deleted;


ALTER SCHEMA deleted OWNER TO dbhasura;
...
--
-- Name: scheduled_stop_point_1666001572785 service_pattern_delete_scheduled_stop_point_trigger; Type: TRIGGER; Schema: deleted; Owner: dbhasura
--

CREATE TRIGGER service_pattern_delete_scheduled_stop_point_trigger INSTEAD OF DELETE ON deleted.scheduled_stop_point_1666001572785 FOR EACH ROW EXECUTE FUNCTION service_pattern.delete_scheduled_stop_point();

--
-- Name: scheduled_stop_point_1666001572785 service_pattern_insert_scheduled_stop_point_trigger; Type: TRIGGER; Schema: deleted; Owner: dbhasura
--

CREATE TRIGGER service_pattern_insert_scheduled_stop_point_trigger INSTEAD OF INSERT ON deleted.scheduled_stop_point_1666001572785 FOR EACH ROW EXECUTE FUNCTION service_pattern.insert_scheduled_stop_point();

--
-- Name: scheduled_stop_point_1666001572785 service_pattern_update_scheduled_stop_point_trigger; Type: TRIGGER; Schema: deleted; Owner: dbhasura
--

CREATE TRIGGER service_pattern_update_scheduled_stop_point_trigger INSTEAD OF UPDATE ON deleted.scheduled_stop_point_1666001572785 FOR EACH ROW EXECUTE FUNCTION service_pattern.update_scheduled_stop_point();
...
CREATE TRIGGER service_pattern_delete_scheduled_stop_point_trigger AFTER DELETE ON service_pattern.scheduled_stop_point FOR EACH ROW EXECUTE FUNCTION service_pattern.delete_scheduled_stop_point();
...
CREATE TRIGGER service_pattern_insert_scheduled_stop_point_trigger BEFORE INSERT ON service_pattern.scheduled_stop_point FOR EACH ROW EXECUTE FUNCTION service_pattern.insert_scheduled_stop_point();
...
CREATE TRIGGER service_pattern_update_scheduled_stop_point_trigger BEFORE UPDATE ON service_pattern.scheduled_stop_point FOR EACH ROW EXECUTE FUNCTION service_pattern.update_scheduled_stop_point();
...
--
-- Name: scheduled_stop_point_1666001572785; Type: VIEW; Schema: deleted; Owner: dbhasura
--

CREATE VIEW deleted.scheduled_stop_point_1666001572785 AS
 SELECT ssp.scheduled_stop_point_id,
    ssp.label,
    ssp.measured_location,
    ssp.located_on_infrastructure_link_id,
...
ALTER TABLE deleted.scheduled_stop_point_1666001572785 OWNER TO dbhasura;
