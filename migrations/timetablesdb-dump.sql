...
COMMENT ON TRIGGER queue_vs_validation_on_update_trigger ON vehicle_service.vehicle_service IS 'Trigger for queuing updated vehicle schedules for later validation.
Actual validation is performed at the end of transaction by execute_queued_validations().';
