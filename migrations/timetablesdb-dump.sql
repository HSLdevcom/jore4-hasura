...
COMMENT ON TRIGGER process_queued_validation_on_vs_trigger ON vehicle_service.vehicle_service IS 'Trigger to execute queued validations that were registered earlier by statement level triggers';
