...
--
-- Name: idx_timetabled_passing_time_scheduled_stop_point_in_journey_pat; Type: INDEX; Schema: passing_times; Owner: dbhasura
--

CREATE INDEX idx_timetabled_passing_time_scheduled_stop_point_in_journey_pat ON passing_times.timetabled_passing_time USING btree (scheduled_stop_point_in_journey_pattern_ref_id);
