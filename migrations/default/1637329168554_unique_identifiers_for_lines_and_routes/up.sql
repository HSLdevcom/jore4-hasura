...
ADD COLUMN direction TEXT REFERENCES route.direction NOT NULL;

ALTER VIEW route.route
RENAME TO route_1637329168554;
...
RENAME TO insert_route_1637329168554;
...
ALTER FUNCTION route.update_route ()
  RENAME TO update_route_1637329168554;
