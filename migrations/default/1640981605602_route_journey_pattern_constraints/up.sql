...
BEGIN
  ...
  IF EXISTS(
    ...
    FROM (
       ...
       -- List all stops of the journey pattern and left-join their visits. In case no visit is present for some
       -- rows (infrastructure_link_sequence is null), it was not possible to visit all stops in a way matching
