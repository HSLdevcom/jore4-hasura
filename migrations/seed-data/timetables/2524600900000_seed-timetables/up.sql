...
INSERT INTO journey_pattern.journey_pattern_ref (journey_pattern_ref_id, journey_pattern_id, observation_date_timestamp, snapshot_timestamp)
VALUES
...
INSERT INTO service_pattern.scheduled_stop_point_in_journey_pattern_ref
  (scheduled_stop_point_in_journey_pattern_ref_id, journey_pattern_ref_id, scheduled_stop_point_label, scheduled_stop_point_label_passing)
VALUES
  ('1f5e10dc-ed58-4cc6-ac03-9830574bfdf4', '77a30292-807a-4cce-b4e2-e95049d3f096','H1234', 1),
  ('4739b73c-56f4-41c0-98e2-0edac7a9e93c', '77a30292-807a-4cce-b4e2-e95049d3f096','H1235', 1),
  ('f2da252c-9498-46ef-8428-c2380158bd6f', '77a30292-807a-4cce-b4e2-e95049d3f096','H1236', 1)
ON CONFLICT DO NOTHING;
...
VALUES
  ('e1a3d7d1-9528-4a2c-9245-7e04f3e1168e', 'JA','{"fi_FI": "Jouluaatto", "sv_FI": "Julafton"}', 20)
ON CONFLICT DO NOTHING;

INSERT INTO vehicle_schedule.vehicle_schedule_frame
  (vehicle_schedule_frame_id, label, name, validity_start, validity_end)
VALUES
  ('10ed8438-878b-4549-82f4-134127824231', '22SYK','{"fi_FI": "2022 Syksy - 2022 Kevät", "sv_FI": "2022 Höst - 2022 Vår"}', '2022-08-15', '2023-06-04')
ON CONFLICT DO NOTHING;
...
VALUES
  -- journey 1 H1234
  ('d0f04468-b667-4af8-8125-0fe23985dc9d', 'f8cfea28-29b8-4495-a707-93aea5673b06', '1f5e10dc-ed58-4cc6-ac03-9830574bfdf4', '05:05:00', NULL),
  -- journey 1 H1235
  ('e074bb5e-520c-4a7f-b485-4f6ef85f0e35', 'f8cfea28-29b8-4495-a707-93aea5673b06', '4739b73c-56f4-41c0-98e2-0edac7a9e93c', '05:15:00', NULL),
  -- journey 1 H1236
  ...
  -- journey 2 H1234
  ('7ba621d9-c4cb-4533-ba76-d1e0235b3911', 'f8cfea28-29b8-4495-a707-93aea5673b06', '1f5e10dc-ed58-4cc6-ac03-9830574bfdf4', '26:10:00', NULL),
  -- journey 2 H1235 missing
  -- journey 2 H1236
  ('d5fc6f50-7e7a-40eb-8a90-8a21628132f1', 'f8cfea28-29b8-4495-a707-93aea5673b06', 'f2da252c-9498-46ef-8428-c2380158bd6f', '26:30:00', '26:31:00')
ON CONFLICT DO NOTHING;
